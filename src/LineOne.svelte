...
<div class="parent">
  ...
  <div class="div2 combination">
    <div class="instrument">A1c</div>
    <div class="track">
      <img src="../assets/img/CV.svg" alt="Left arrow" />
      <div class="number">11</div>
    </div>
  </div>
  <div class="div3 track">
    <img src="../assets/img/CV.svg" alt="Left arrow" />
  ...
  <div class="div5 combination">
    <XN
      serialNO="{$instrumentSerialNOs.lineOne.unitSerial8}"
      unitNO="1-8"
      {writeSerialNO}
    ></XN>
    <div class="track">
  ...
  <div class="div6 combination">
    <XN
      serialNO="{$instrumentSerialNOs.lineOne.unitSerial7}"
      unitNO="1-7"
      {writeSerialNO}
    ></XN>
    <div class="track">
  ...
  <div class="div7 combination">
    <XN
      serialNO="{$instrumentSerialNOs.lineOne.unitSerial6}"
      unitNO="1-6"
      {writeSerialNO}
    ></XN>
    <div class="track">
  ...
  <div class="div10 track">
    <img src="../assets/img/TS.svg" alt="TS" />
...
<style>
  .parent {
    display: grid;
    grid-template-columns: 1fr 1.5fr 1fr 1.5fr repeat(3, 1fr) repeat(2, 0.75fr) 1.5fr repeat(
        2,
        0.75fr
      );
